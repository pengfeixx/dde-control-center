                                ...
                                Control {
                                    ...
                                    contentItem: ColumnLayout {
                                        Label {
                                            ...
                                            Layout.leftMargin: 6
                                            Layout.rightMargin: 10
                                            text: qsTr("2.please go to <a style='text-decoration: none;' href=\"http://www.chinauos.com/developMode\">http：//www.chinauos.com/developMode</a> to Download offline certificate.")
